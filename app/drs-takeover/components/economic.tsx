  ...
  items: [
    {
      ...
      description:
        "ECOcans’ LCD touchscreen seamlessly guides users on how to operate the devises. This display doubles as a platform for targeted advertising, helping you earn extra income on the side, while boosting your brand visibility. By delivering a personalised recycling experience, ECOcans enhance customer engagement, which keeps them coming back.",
    },
    {
