...
const accordionData: AccordionData[] = [
  {
    ...
    description: (
      <div className="space-y-2 w-11/12">
        <div>
          The blockchain-compatible TnT technology protects deposit refunds
          across the ECO-system, ensuring they are redeemed only once. With
          AI-enhanced real-time validation, deposits are accurately recorded,
          and instantly refunded to the rightful ECOnsumer, preventing front-end
          fraud.
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    description: (
      <div className="space-y-2 w-11/12">
        <div>
          With TnT diagnostics, you can conveniently monitor Pure ECOcans&apos;
          performance remotely from your mobile devices, receiving real-time
          status updates. This allows you to track daily usage, anticipate
          trends, and troubleshoot any issues ahead of time, keeping device
          uptime at its best.
        </div>
      </div>
    ),
