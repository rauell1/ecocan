...
export default function Heading() {
  return (
    <section
      className="relative pb-16 pt-24"
      id="eco_friendly_cans"
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 30% 0%, rgba(34,197,94,0.04) 0%, transparent 65%)",
        }}
      />
      <div className="relative z-10 mx-auto max-w-[72rem] px-4 py-8 lg:pb-16 lg:pt-20 xl:px-0">
        <p className="section-overline mb-4 text-[var(--c-green)]">ECO-friendly cans</p>
        <TextWithComponent
          title={
            <span
            ...
            >
              ...
              <br />
              <span className="font-sans font-light text-[var(--c-green)]">at scale.</span>
            </span>
          }
          description={
            <p className="mt-2 text-[15px] leading-relaxed text-[var(--c-text-muted)] lg:w-3/4">
