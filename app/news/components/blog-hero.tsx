  ...
  return (
    ...
    >
      ...
      <div className="relative h-60 overflow-hidden lg:h-full lg:w-1/2">
        <Image
          src={blogHero}
          alt="Kenya EPR waste management"
          fill
      ...
      <div className="flex flex-col justify-center p-7 lg:w-1/2 lg:p-10">
        ...
        <p className="mb-7 text-[15px] leading-relaxed" style={{ color: "rgba(255,255,255,0.6)" }}>
          Kenya becomes the second country in Africa to enact Extended Producer Responsibility
          legislation — a landmark step for circular packaging.
        </p>
        <a
          href="#"
          className="inline-flex w-fit items-center gap-2 rounded-full px-5 py-2.5 text-[13.5px] font-semibold text-white transition-all duration-200 hover:gap-3"
          style={{
