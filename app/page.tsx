...
export default function Home() {
  ...
  const sections = useMemo(
    () => [
      ...
      { id: "how-it-works", label: "How Recycling Works" },
      { id: "ecommunity", label: "Rewards" },
      { id: "app", label: "App" },
      { id: "investors", label: "Brands & Investors" },
      { id: "faq", label: "FAQ" },
    ],
    []
  );

  // Scroll spy logic (unchanged, just keeps track of which block the consumer is in)
  useEffect(() => {
    const handleScroll = () => {
