  ...
  return (
    <section id="ecocan-app" className="space-y-12 border py-24">
      ...
      <div className="text-center relative">
        ...
        />
        <AppStoreButton
          className="md:absolute bottom-4 lg:bottom-8 lg:left-1/2 md:-translate-x-[5.125rem] hover:bg-primary bg-primary text-sm lg:text-base text-white hover:text-white no-underline px-8 lg:hidden"
        ...
        <ScanqrPopup
          ...
          className="md:absolute bottom-4 lg:bottom-8 lg:left-1/2 md:-translate-x-[5.125rem] hover:bg-primary bg-primary text-sm lg:text-base text-white hover:text-white no-underline px-8 hidden lg:flex"
        />
      </div>
    </section>
  );
