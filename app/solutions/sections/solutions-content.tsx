    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 40%, rgba(34,197,94,0.04) 0%, transparent 60%)",
          }}
        />

        {/* Content */}
        <div className="relative z-10 mx-auto w-full max-w-[1280px] px-[clamp(1.25rem,4vw,3rem)] text-center">
          <p className="hero-animate section-overline mb-6 justify-center text-[var(--c-green)]">
            Our offering
          </p>
          <h1
          ...
          <p className="hero-animate mx-auto max-w-[560px] text-[16px] leading-relaxed text-[var(--c-text-muted)]">
