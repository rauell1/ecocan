  ...
  return (
    <>
      ...
      <div className="lg:h-[36rem] xl:h-[40rem]">
        <div className="bg-[url('/assets/images/solutions/solution-hero.svg')] lg:h-[32rem] xl:h-[44rem] bg-cover bg-[-5px] relative after:absolute after:inset-0 after:content-[''] after:bg-black/90 after:opacity-50 after:z-10">
