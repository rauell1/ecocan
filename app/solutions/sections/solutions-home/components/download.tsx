  ...
  return (
    <div className="max-w-[72rem] xl:mx-auto px-4 lg:ms-4 xl:px-0 bg-[url('/assets/images/solutions/download-bg.svg')] hidden lg:h-[43.75rem] lg:flex flex-col justify-center">
      <div className="ms-10">
        ...
        <AppStoreButton
          className="bg-white hover:bg-white text-primary mt-8 border px-8 no-underline font-medium lg:hidden"
        ...
        <ScanqrPopup
          ...
          className="bg-white hover:bg-white text-primary mt-8 border px-8 no-underline font-medium hidden lg:flex"
        />
        <div className="mt-20">
          <Image
