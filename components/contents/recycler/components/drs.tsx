...
const steps = [
  {
    ...
    icon: (
      <div>
        <div className="flex h-[3.75rem] w-[3.75rem] items-center justify-center rounded-full bg-white shadow-lg">
          <Image
    ...
    description: (
      <div>
        ...
        />{" "}
        directives, a DRS is the only take-back system that can collect +90% empties. And ECOCAN has
        enhanced this efficacy via the TnT & EcocanApp
      </div>
    ),
  },
  {
    ...
    icon: (
      <div>
        <div className="flex h-[3.75rem] w-[3.75rem] items-center justify-center rounded-full bg-white shadow-lg">
          <Image src="/assets/images/recycler/earth_icon.svg" width={40} height={40} alt="icon" />
        </div>
      </div>
    ),
    ...
    description: (
      <p>
        A Nordic-design DRS is aligned with the &lsquo;Polluter Pays Principle&rsquo;, and most
        effectively fulfils this mandate. Our traceability technology optimises this capability
      </p>
    ),
  },
  {
...
export default function DepositRefundSystem() {
  return (
    <div className="mx-auto max-w-[72rem] px-4 py-8 lg:pb-24 xl:px-0">
      <ImageAndItem
        className="items-center gap-12"
        title={<h2 className="text-start">Why a Deposit Refund System?</h2>}
        description={
          <p className="text-start text-muted-foreground lg:my-8">
