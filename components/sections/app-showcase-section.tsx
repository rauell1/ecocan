...
export default function AppShowcaseSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-[clamp(1.25rem,4vw,3rem)] text-center">
        <h2
        ...
        <div
          ref={phonesRef}
          className="phone-center ec-reveal mx-auto my-14 w-[min(340px,75vw)] drop-shadow-[0_0_60px_rgba(16,185,129,0.25)] filter transition-transform duration-500 hover:scale-[1.03]"
        >
          <Image
        ...
        <div className="ec-reveal flex flex-wrap items-center justify-center gap-4">
          <Link
            ...
            className="inline-flex rounded-full border border-white/10 bg-white/5 px-8 py-3 text-[14px] font-medium text-white backdrop-blur-md transition-all duration-300 hover:border-emerald-500/20 hover:bg-emerald-500/10 hover:text-emerald-400"
          >
            App Store
          </Link>
          <Link
