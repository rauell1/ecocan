    ...
    >
      ...
      <div className="relative max-w-[1280px] mx-auto px-6">
        <div className="max-w-[760px] mx-auto text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.15em] text-primary mb-4">Join the Movement</p>
        <h2
        ...
        <p className="text-white/80 text-lg mb-10 max-w-[520px] mx-auto leading-relaxed">
