  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(\"data:image/svg+xml,%3Csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.75' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='200' height='200' filter='url(%23n)' opacity='1'/%3E%3C/svg%3E\")",
        }}
      />
      ...
      <div className="site-container relative z-10">
        ...
        <div className="mb-16 max-w-[640px]">
          ...
          <p className="ec-reveal section-subhead">
            Counterfeit drinks and plastic waste are two sides of the same broken supply chain —
            ECOCAN closes both loops.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          {/* Problem card */}
          <div
            className="ec-reveal ec-card group p-8 md:p-10"
        ...
        {/* Impact stats strip */}
        <div className="ec-reveal bg-white/07 mt-10 grid grid-cols-2 gap-px overflow-hidden rounded-[--radius-card] md:grid-cols-4">
          {[
            ...
            <div
              key={label}
              className="flex flex-col items-center justify-center bg-[--c-surface] p-7 text-center"
            >
              <span className="stat-number mb-1">{value}</span>
              <span className="max-w-[14ch] text-xs font-medium leading-snug text-white/45">
                {label}
              </span>
            </div>
          ))}
