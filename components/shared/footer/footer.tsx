        ...
        <div className="grid grid-cols-1 md:grid-cols-10 gap-10 mb-14">
          ...
          <div className="col-span-10 md:col-span-2">
            ...
            <div className="grid grid-cols-3 gap-2 w-fit">
              <Link href="https://facebook.com/EcocanAfrica" target="_blank" rel="noopener noreferrer" className="w-fit transition-opacity hover:opacity-80">
                <Image
              ...
              <Link href="https://twitter.com/EcocanAfrica" target="_blank" rel="noopener noreferrer" className="w-fit transition-opacity hover:opacity-80">
                <Image
              ...
              <Link href="https://www.instagram.com/ecocanafrica?igsh=eHEycmVwYnV3OGR2" target="_blank" rel="noopener noreferrer" className="w-fit transition-opacity hover:opacity-80">
                <Image
              ...
              <Link href="https://tiktok.com/@ecocanafrica" target="_blank" rel="noopener noreferrer" className="w-fit transition-opacity hover:opacity-80">
                <Image
              ...
              <Link href="https://linkedin.com/company/ecocan" target="_blank" rel="noopener noreferrer" className="w-fit transition-opacity hover:opacity-80">
                <Image
              ...
              <Link href="https://www.youtube.com/@EcocanAfrica" target="_blank" rel="noopener noreferrer" className="w-fit transition-opacity hover:opacity-80">
                <Image
