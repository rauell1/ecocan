  ...
  "inline-flex items-center justify-center rounded-full font-medium transition-colors",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border text-foreground px-2.5 py-0.5 text-xs",
        eco:
         ...
         */
        live:
          "bg-green-500/10 border border-green-500/20 text-green-700 dark:text-green-400 px-3 py-1 text-xs font-medium gap-2",
      },
    },
    defaultVariants: {
      variant: "default",
