 ...
 * Dropdown: rounded-2xl, card shadow, white bg
 * Selected indicator: primary green checkmark
 */
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 pl-8 pr-2 text-[11px] font-semibold uppercase tracking-[0.08em] text-muted-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "rounded-xl py-2 pl-8 pr-2 text-sm",
      "outline-none",
